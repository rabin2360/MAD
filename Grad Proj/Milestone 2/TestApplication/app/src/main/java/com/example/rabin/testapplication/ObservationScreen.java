...
public class ObservationScreen extends AppCompatActivity {
    ...
    private Button stdObserving;
    private Button stdParticipating;
    private Button stdDisEngaged;
    private Button stdVerbal;
    private Button stdMotor;
    private Button stdAggressive;
    private Button stdOutOfSeat;

    //buttons for peer being observed
    private Button prObserving;
    private Button prParticipating;
    private Button prDisEngaged;
    private Button prVerbal;
    private Button prMotor;
    private Button prAggressive;
    private Button prOutOfSeat;
    ...
    private void observationInit()
    {
        ...
        stdObserving = (Button) findViewById(R.id.stdObsButton);
        stdParticipating = (Button) findViewById(R.id.stdParticipatingButton);
        stdDisEngaged = (Button) findViewById(R.id.stdDisEngagedButton);
        stdVerbal = (Button) findViewById(R.id.stdVerbal);
        stdMotor = (Button) findViewById(R.id.stdMotor);
        stdAggressive = (Button) findViewById(R.id.stdAggressive);
        stdOutOfSeat = (Button) findViewById(R.id.stdOutOfSeat);

        prObserving = (Button) findViewById(R.id.prObsButton);
        prParticipating = (Button) findViewById(R.id.prParticipatingButton);
        prDisEngaged = (Button) findViewById(R.id.prDisEngagedButton);
        prVerbal = (Button) findViewById(R.id.prVerbal);
        prMotor = (Button) findViewById(R.id.prMotor);
        prAggressive = (Button) findViewById(R.id.prAggressive);
        prOutOfSeat = (Button) findViewById(R.id.prOutOfSeat);
    }
